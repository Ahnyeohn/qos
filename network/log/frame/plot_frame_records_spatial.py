...
def plot_slacks_with_spatial_and_bitrate(df: pd.DataFrame, out_path: str) -> None:
    ...
    ax1.set_title("Slack metrics with currentSpatialLayer and availableBitrate")
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Plot slack metrics with currentSpatialLayer and availableBitrateMbps"
    )
    parser.add_argument(
        "-pacing",
        type=int,
